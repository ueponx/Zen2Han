# Zen2Han
![Zen2Han Logo](images/icon128-active.png)
## 概要
...
- **状態表示**: 有効/無効状態に応じてアイコンが切り替わり、現在の状態を視覚的に確認可能
## 変換対象文字
...
4. アイコンの見た目で現在の状態を確認できます（レッド：有効、ブルー：無効）
## スクリーンショット
...
└── images/          # アイコンなどの画像ファイル
    ├── icon16.png            # 通常の16x16アイコン
    ├── icon48.png            # 通常の48x48アイコン
    ├── icon128.png           # 通常の128x128アイコン
    ├── icon16-active.png     # アクティブ状態の16x16アイコン
    ├── icon48-active.png     # アクティブ状態の48x48アイコン
    └── icon128-active.png    # アクティブ状態の128x128アイコン
```
## ライセンス
